...
function StaffCreate() {
  ...
  const [staff, setStaff] = useState<Partial<StaffsInterface>>({});
  ...
  const handleInputChange = (
    ...
    const id = event.target.id as keyof typeof staff;
    ...
    <Container className={classes.container} maxWidth="md">
      ...
      <Paper className={classes.paper}>
        ...
        <Grid container spacing={3} className={classes.root}>
          ...
          <Grid item xs={12}>
            <Button component={RouterLink} to="/staffs" variant="contained">
              กลับ
            </Button>
            <Button
              style={{ float: "right" }}
